...
public class AddEmployementStatus {
...
try {
	 ...
	 String employmentStatus = p.getProperty("employmentStatus");		
	 String addEmploymentStatus = p.getProperty("add_skills");		 		 	
	 String jobCategoriesName = p.getProperty("jobTitleName");		 	
	 String employmentStatusNameInput = p.getProperty("employmentStatusNameInput");
	 ...
	 d.findElement(By.xpath(employmentStatus)).click();
	 Thread.sleep(2000);

	 d.findElement(By.xpath(addEmploymentStatus)).click();
    Thread.sleep(2000);	
 
	 // save Categories
    d.findElement(By.xpath(jobCategoriesName)).sendKeys(employmentStatusNameInput);
    Thread.sleep(2000);	
