...
try {
	 ...
	 String jobShiftNameInput = p.getProperty("jobShiftName");
	 String jobShiftName = p.getProperty("jobTitleName");
    ...
    // Save workshift
	 d.findElement(By.xpath(jobShiftName)).sendKeys(jobShiftNameInput);
	 Thread.sleep(3000);
