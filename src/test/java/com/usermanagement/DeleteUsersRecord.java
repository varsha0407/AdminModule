...
public class DeleteUsersRecord {
 public static void main(String[] args) {
  try {
	  ...
	  String Checkbox1 = p.getProperty("Checkbox1");		
	  String Checkbox2 = p.getProperty("Checkbox2");		
	  String deleteUser = p.getProperty("delete_user");		
	  ...
	  d.findElement(By.xpath(Checkbox1)).click();
	  Thread.sleep(2000);
		 
	  d.findElement(By.xpath(Checkbox2)).click();
	  Thread.sleep(2000);
		
	  d.findElement(By.xpath(deleteUser)).click();
	  Thread.sleep(2000);
