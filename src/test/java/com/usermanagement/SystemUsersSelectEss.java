...
public class SystemUsersSelectEss {
public static void main(String[] args) {
	try {
		...
		String userRole1 = p.getProperty("user_role1");
		String userRoleEss = p.getProperty("user_role_ess");			
		...
		// Select ESS from User Role

		WebElement user_role2 = d.findElement(By.xpath(userRole1));
	    user_role2.click();
	    Thread.sleep(2000);
					
		d.findElement(By.xpath(userRoleEss)).click();
		Thread.sleep(2000);
