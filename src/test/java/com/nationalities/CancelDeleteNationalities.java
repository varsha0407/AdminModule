...
public class CancelDeleteNationalities {
...
try {
		 ...
		 String deleteNationalities = p.getProperty("deleteskill");		 	
	    ...
	    d.get(url);
	     ...
	     // cancel to delete nationalities

		 d.findElement(By.xpath(chechbox2)).click();
	    Thread.sleep(2000);	
	 
	    d.findElement(By.xpath(deleteNationalities)).click();
	    Thread.sleep(2000);	
