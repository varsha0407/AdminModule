...
try {
   ...
   c.addArguments("--remote-allow-origins=*");
	 ...
	 String addLanguage = p.getProperty("add_skills");		 		 	
	 String languageName = p.getProperty("educationName");		 	
	 String languageNameInput = p.getProperty("langaugeNameInput");
	 ...
	 // click on language
	 d.findElement(By.xpath(language)).click();
	 Thread.sleep(2000);

	 d.findElement(By.xpath(addLanguage)).click();
    Thread.sleep(2000);	
 
	 // save language
    d.findElement(By.xpath(languageName)).sendKeys(languageNameInput);
    Thread.sleep(2000);	
