...
public class AddMembershipSave {
...
try {
   ...
   c.addArguments("--remote-allow-origins=*");
	 ...
	 String membership = p.getProperty("membership");		
	 String addMembership = p.getProperty("add_skills");		 		 	
	 String membershipName = p.getProperty("educationName");		 	
	 String membershipInput = p.getProperty("membershipInput");
	 ...
	 // click on membership
	 d.findElement(By.xpath(membership)).click();
	 Thread.sleep(2000);

	 d.findElement(By.xpath(addMembership)).click();
     Thread.sleep(2000);	
 
	 // save membership
     d.findElement(By.xpath(membershipName)).sendKeys(membershipInput);
     Thread.sleep(2000);	
