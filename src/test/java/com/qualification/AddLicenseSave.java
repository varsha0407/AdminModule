...
try {
    ...
    c.addArguments("--remote-allow-origins=*");
	 ...
	 String addLicenses = p.getProperty("add_skills");		 		 	
	 String licensesName = p.getProperty("educationName");		 	
	 String licensesNameInput = p.getProperty("licenseNameInput");
	 ...
	 d.findElement(By.xpath(addLicenses)).click();
     Thread.sleep(2000);	
  
	 // save licenses
     d.findElement(By.xpath(licensesName)).sendKeys(licensesNameInput);
     Thread.sleep(2000);	
