...
public class CancelDeleteMembership {
...
try {
	WebDriverManager.chromedriver().setup();	
	 ...
	 String deleteMembership = p.getProperty("deleteskill");		 	
	 String noCancelButton = p.getProperty("noCancelButton");
	 ...
	 // Cancel membership
     d.findElement(By.xpath(deleteMembership)).click();
     Thread.sleep(2000);	
