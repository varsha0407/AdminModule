...
try {
	 ...
	 String education = p.getProperty("education");		
	 String addEducation = p.getProperty("add_skills");		 		 	
	 String educationName = p.getProperty("educationName");		 	
	 String educationNameInput = p.getProperty("educationNameInput");
	 ...
	 // click on education
	 d.findElement(By.xpath(education)).click();
	 Thread.sleep(2000);

	 d.findElement(By.xpath(addEducation)).click();
     Thread.sleep(2000);	
   
	 // save education
    d.findElement(By.xpath(educationName)).sendKeys(educationNameInput);
    Thread.sleep(2000);	
