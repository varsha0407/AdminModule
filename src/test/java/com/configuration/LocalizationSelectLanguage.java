...
public class LocalizationSelectLanguage {
...
try {
	WebDriverManager.chromedriver().setup();	
	 ...
	 String languageName1 = p.getProperty("languageName1");		 		 	
	 String languageListbox = p.getProperty("languageListbox");		 	
	 ...
	 WebElement languageName = d.findElement(By.xpath(languageName1));
	 languageName.click();
     Thread.sleep(2000);	

     d.findElement(By.xpath(languageListbox)).click();
     Thread.sleep(2000);	
