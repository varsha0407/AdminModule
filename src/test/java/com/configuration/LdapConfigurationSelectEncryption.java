...
public class LdapConfigurationSelectEncryption {
...
try {
    ...
    c.addArguments("--remote-allow-origins=*");
	 ...
	 String encryption = p.getProperty("encryption");		 		 	
	 String encryptionListbox = p.getProperty("searchScopeListbox");		 	
    ...
    d.get(url);
	 ...
	 // select TLS from encryption listbox
	 
	 WebElement encryption1 = d.findElement(By.xpath(encryption));
	 encryption1.click();
    Thread.sleep(3000);	

    d.findElement(By.xpath(encryptionListbox)).click();
    Thread.sleep(2000);	
