...
public class LdapConfigurationSearchScope {
...
try {
	WebDriverManager.chromedriver().setup();	
	 ...
	 String searchScope = p.getProperty("searchScope");		 		 	
	 String searchScopeListbox = p.getProperty("searchScopeListbox");		 	
	 ...
	 // select One level from search scope listbox
	 
	 WebElement searchScope1 = d.findElement(By.xpath(searchScope));
	 searchScope1.click();
     Thread.sleep(3000);	

     d.findElement(By.xpath(searchScopeListbox)).click();
     Thread.sleep(2000);	
